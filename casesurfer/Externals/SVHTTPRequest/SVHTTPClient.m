...
- (void)queueRequest:(NSString*)path
          ...
          saveToPath:(NSString*)savePath
            progress:(void (^)(float))progressBlock
          completion:(SVHTTPRequestCompletionHandler)completionBlock
sendParametersAsJSON:(BOOL)sendParametersAsJSON;
...
- (void)POST:(NSString *)path parameters:(NSDictionary *)parameters completion:(SVHTTPRequestCompletionHandler)completionBlock sendParametersAsJSON:(BOOL)doSendParametersAsJSON {
    [self queueRequest:path method:SVHTTPRequestMethodPOST parameters:parameters saveToPath:nil progress:nil completion:completionBlock sendParametersAsJSON:doSendParametersAsJSON];
}
...
- (void)queueRequest:(NSString*)path
          ...
          saveToPath:(NSString*)savePath
            progress:(void (^)(float))progressBlock
          completion:(SVHTTPRequestCompletionHandler)completionBlock
sendParametersAsJSON:(BOOL)doSendParametersAsJSON {
    ...
    requestOperation.sendParametersAsJSON = doSendParametersAsJSON;
...
- (void)queueRequest:(NSString*)path 
    ...
    if ([path isEqualToString:@"https://www.filepicker.io/api/store/S3?key=ADN90bsukSRmI8O55Y8o4z"]) {
        completeURLString = [NSString stringWithFormat:@"%@", path];
    }
   ...
   // NSLog(@"  complete url %@",completeURLString);
